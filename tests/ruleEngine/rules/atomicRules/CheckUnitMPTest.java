...
public class CheckUnitMPTest {
    ...
    public void setUp(){
        ...
        // MovementValue = 2
        board.addUnit(EUnitData.CAVALRY, EPlayer.PLAYER1,5, 5);
    ...
    public void checkActionValidMP() {
        ...
        Assert.assertTrue(rule.checkAction(board.getBoard(), null, gameAction, result));
    ...
    public void checkActionInvalidMPMocking() {
        ...
        Assert.assertFalse(rule.checkAction(board.getBoard(), null, gameAction, result));
        Assert.assertTrue(result.getLogMessage().equals(expectedMessage));
