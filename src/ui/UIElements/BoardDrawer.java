...
class BoardDrawer {
    ...
    static void drawUnit(GraphicsContext g, EUnitProperty unitID, EPlayer player, int pos_x, int pos_y, int size) {
    ...
    static void drawBuilding(GraphicsContext g, EBuildingProperty buildingID, EPlayer player, int pos_x, int pos_y, int size, int margin) {
        switch (buildingID) {
            case MOUNTAIN:
